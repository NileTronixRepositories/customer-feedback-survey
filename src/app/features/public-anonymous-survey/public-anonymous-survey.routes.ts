...
import { PublicAnonymousTemplatePageComponent } from './presentation/pages/public-anonymous-template-page/public-anonymous-template-page.component';
...
export const PUBLIC_ANONYMOUS_SURVEY_ROUTES: Routes = [
  {
    ...
    loadComponent: () =>
      import(
        './presentation/pages/public-anonymous-template-success-page/public-anonymous-template-success-page.component'
