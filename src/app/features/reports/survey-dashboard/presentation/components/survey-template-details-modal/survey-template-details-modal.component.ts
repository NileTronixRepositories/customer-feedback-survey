...
import { BranchTemplateQuestionTreeComponent } from '../../../../../branch-admin/templates/presentation/components/branch-template-question-tree/branch-template-question-tree.component';
import {
...
@Component({
  ...
  styleUrl: './survey-template-details-modal.component.css',
